...
//-----------------------------------------------------CORREGIR---------------------------------------------------------
    ...
    public NotaFinal[] corregir() {
        if(_seChequearonCopias){
            ...
            ArrayList<MinHeap<Estudiante>.HandleMinHeap<Estudiante>> estudiantesOrdenados = _heapEstudiantes.conseguirKElementos(estudiantesQueNoSeCopiaron);
            ...
            return null;
            // si no se chequearon copias ni entregaron todos, no puedo corregir 
        }
...
//-------------------------------------------------------CHEQUEAR COPIAS-------------------------------------------------
    ...
    public int[] chequearCopias() {
        if(_cantEstudiantes == _estudiantesQueEntregaron){
